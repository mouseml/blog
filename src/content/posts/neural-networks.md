...
thumbnail: images/posts/neural-networks/thumbnail.jpg
minutes: 24
---
...
Для начала вам потребуется примерное понимание основных шагов ML проекта, и в целом понятия ML модели. Если вы в чем-то из этого не уверены, советую начать с общего [введения в машинное обучение](https://youtu.be/s0de5Q4taFE). Кроме этого от вас потребуется только знание школьной математики, а все остальное разберем по ходу видео.
...
![Плохая схема нейронной сети](/blog/images/posts/neural-networks/nn_scheme_bad.png)
...
![Схема нейронной сети](/blog/images/posts/neural-networks/nn_scheme.png)
...
![Промежуточные признаки](/blog/images/posts/neural-networks/intermediate_features.png)
...
![Умножение матриц: постановка](/blog/images/posts/neural-networks/dot_product_setup.png)
...
![Умножение матриц: результат](/blog/images/posts/neural-networks/dot_product_result.png)
...
![Схема нейронной сети](/blog/images/posts/neural-networks/nn_scheme_detailed.png)
...
![Функция активации ReLU](/blog/images/posts/neural-networks/activation_relu.png)
...
![Функция активации Sigmoid](/blog/images/posts/neural-networks/activation_sigmoid.png)
...
Теперь осталось только обучить модель, но перед этим советую вам создать еще несколько моделей, чтобы проверить себя и убедиться, что вы научились читать схемы. Попробуйте создать вот эти 3 модели, а решение найдете в файле [↓ models.py](/blog/static/posts/neural-networks/models.py).

![Задача](/blog/images/posts/neural-networks/nn_scheme_task.png)
...
![Бинарная кросс-энтропия](/blog/images/posts/neural-networks/loss_cross_entropy.png)
...
![Градиентный спуск: инициализация](/blog/images/posts/neural-networks/gradient_descent_init.png)
...
![Градиентный спуск: упрощенная версия](/blog/images/posts/neural-networks/gradient_descent_dummy.png)
...
![Градиентный спуск](/blog/images/posts/neural-networks/gradient_descent.png)
...
![Iris](/blog/images/posts/neural-networks/iris_overview.png)

Параметров всего 4 - длина и ширина чашелистика (sepal) и длина и ширина лепестка (petal). Если хотите писать код вместе со мной, скачайте файлы [↓ data.pt](/blog/static/posts/neural-networks/data.pt) и [↓ target.pt](/blog/static/posts/neural-networks/target.pt) и положите в папку c проектом.
...
```python {10,14,15,16,17,18,19,20}
import torch
from torch.nn import Sequential, Linear, ReLU, CrossEntropyLoss
from torch.optim import SGD
