...
![Плохая схема нейронной сети](/blog/images/posts/nn/nn_scheme_bad.png)
...
![Схема нейронной сети](/blog/images/posts/nn/nn_scheme.png)
...
![Промежуточные признаки](/blog/images/posts/nn/intermediate_features.png)
...
![Умножение матриц: постановка](/blog/images/posts/nn/dot_product_setup.png)
...
![Умножение матриц: результат](/blog/images/posts/nn/dot_product_result.png)
...
![Схема нейронной сети](/blog/images/posts/nn/nn_scheme_detailed.png)
...
![Функция активации ReLU](/blog/images/posts/nn/activation_relu.png)
...
![Функция активации Sigmoid](/blog/images/posts/nn/activation_sigmoid.png)
...
Теперь осталось только обучить модель, но перед этим советую вам создать еще несколько моделей, чтобы проверить себя и убедиться, что вы научились читать схемы. Попробуйте создать вот эти 3 модели, а решение найдете в файле [↓ models.py](/blog/static/posts/nn/models.py).

![Задача](/blog/images/posts/nn/nn_scheme_task.png)
...
![Бинарная кросс-энтропия](/blog/images/posts/nn/loss_cross_entropy.png)
...
![Градиентный спуск: инициализация](/blog/images/posts/nn/gradient_descent_init.png)
...
![Градиентный спуск: упрощенная версия](/blog/images/posts/nn/gradient_descent_dummy.png)
...
![Градиентный спуск](/blog/images/posts/nn/gradient_descent.png)
...
![Iris](/blog/images/posts/nn/iris_overview.png)

Параметров всего 4 - длина и ширина чашелистика (sepal) и длина и ширина лепестка (petal). Если хотите писать код вместе со мной, скачайте файлы [↓ data.pt](/blog/static/posts/nn/data.pt) и [↓ target.pt](/blog/static/posts/nn/target.pt) и положите в папку c проектом.
