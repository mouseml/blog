...
![Виды тензоров](/blog/images/posts/torch/tensor_types.png)
...
![Случайное разбиение](/blog/images/posts/torch/train_test_split.png)
...
![Случайное разбиение с перемешиванием](/blog/images/posts/torch/train_test_split_shuffle.png)
...
![Нормализация](/blog/images/posts/torch/standard_scaler.png)
...
![Хранение тензоров и списков в памяти](/blog/images/posts/torch/array_storage.png)
...
![Градиентный спуск: общая идея](/blog/images/posts/torch/gradient_descent_idea.png)
...
![Градиентный спуск](/blog/images/posts/torch/gradient_descent.png)
...
Получаем примерно полбалла. Это неплохой результат, но вы можете попробовать улучшить его. Для этого можно изменить количество шагов градиентного спуска, коэффициент обучения или использовать модель с большим количеством слоев. Пример обучения двухслойной модели можете найти в файле [↓ model.py](/blog/static/posts/torch/model.py).
