...
thumbnail: images/posts/machine-learning/thumbnail.jpg
minutes: 12
---
...
![Дерево решений: первое разбиение](/blog/images/posts/machine-learning/decision_tree_first_split.png)
...
![Дерево решений: все разбиения](/blog/images/posts/machine-learning/decision_tree_all_splits.png)
...
![Дерево решений](/blog/images/posts/machine-learning/decision_tree_complete.png)
...
Сложная, расширяемая архитектура с возможностью добавления специальных слоев для анализа изображений и текста сделала нейронные сети одной из самых популярных моделей машинного обучения. Мы изучали нейронные сети более подробно в [другом разборе](nn.md).
...
![Кластеризация: пример](/blog/images/posts/machine-learning/task_clustering.png)
...
![Разведочный анализ: гистограммы и столбчатые диаграммы](/blog/images/posts/machine-learning/eda_distributions.png)
...
![Разведочный анализ: матрица корреляции](/blog/images/posts/machine-learning/eda_correlation_matrix.png)
...
![Пример разложения изображения по палитре RGB](/blog/images/posts/machine-learning/rgb_palette.png)
...
Поэтому на практике обычно кодируют наиболее часто встречающиеся части слов, которые которые могут соответствовать *морфемам*: приставкам, суффиксам, корням или окончаниям. Это позволяет уменьшить размер словаря, но сохранить возможность работы на уровне слов. При этом кодировка похожих слов, например "синий" и "синеватый" также будет схожей. Именно такой подход используется, например, в ChatGPT и других в современных языковых моделях.
...
![Разбиение выборки](/blog/images/posts/machine-learning/train_test_split.png)
...
Data Scientist сохраняет обученную модель в виде бинарного файла и загружает ее в репозиторий моделей. ML инженер пишет код, который скачивает модель и делает с ее помощью новые предсказания для новых объектов. В большинстве случаев пишется небольшой back-end сервер — в Python это можно сделать с помощью фреймворков FastAPI, Django или Flask.
...
![Переобучение: пример на деревьях](/blog/images/posts/machine-learning/decision_tree_overfit.png)
...
На этом у меня все. Местами я сильно упростил материал и мог допустить неточности, поэтому буду рад любым комментариям и уточнениям. Их можно закинуть через [GitHub Issues](https://github.com/mouseml/blog/issues) или в [Telegram](https://www.t.me/ml_mouse).

Все, о чем мы сегодня говорили, будем изучать более подробно в следующих разборах. Поэтому добавляйте блог в закладки и подписывайтесь на [YouTube канал](https://www.youtube.com/channel/UCscWjyvPudzdIaGCCtEL3nw). Увидимся в код ревью, всем пока!
