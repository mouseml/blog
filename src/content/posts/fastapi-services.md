...
excerpt: Превращаем обученную модель в сервис с помощью FastAPI.
...
![Страница приложения со статичными компонентами](/blog/images/posts/fastapi-services/interface-1.png)
...
![Страница приложения с интерактивными элементами](/blog/images/posts/fastapi-services/interface-2.png)
...
![Готовая форма заявки на Streamlit](/blog/images/posts/fastapi-services/interface-3.png)
