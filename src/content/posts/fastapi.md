...
![Архитектура проекта](/blog/images/posts/fastapi/architecture.png)
...
Данные в таком виде уже подготовлены в файле [↓ scoring.csv](/blog/static/posts/fastapi/scoring.csv), а полный код проекта [доступен на GitHub](https://github.com/mouseml/credit_scoring).
...
![Пример микросервисной архитектуры](/blog/images/posts/fastapi/services.png)
...
![Страница Swagger UI](/blog/images/posts/fastapi/swagger.png)
...
![Страница Swagger UI](/blog/images/posts/fastapi/interface-1.png)
...
![Страница Swagger UI](/blog/images/posts/fastapi/interface-2.png)
...
![Страница Swagger UI](/blog/images/posts/fastapi/interface-3.png)
