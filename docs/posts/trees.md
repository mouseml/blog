...
categories:
  - Теория
links:
  - Видео на YouTube: https://youtu.be/-_l3smVnga4
---

# Самая простая ML модель — решающее дерево

![Обложка](../images/posts/trees/thumbnail.jpg)
...
![Первая группа студентов](../images/posts/trees/data1.png)
...
![Деление по правилу 7 лекций](../images/posts/trees/data1_split7.png)
...
![Деление по правилу 3 лекций](../images/posts/trees/data1_split3.png)
...
![Деление по правилу 4 лекций](../images/posts/trees/data1_split4.png)

Это правило приводит к полному порядку — достаточно было посетить больше 4 лекций, чтобы сдать зачет:

![Решающее дерево для первой группы студентов](../images/posts/trees/tree1.png)
...
![Данные на плоскости](../images/posts/trees/chart1.png)
...
![Правила на плоскости](../images/posts/trees/chart1_options.png)
...
![Решение на плоскости](../images/posts/trees/chart1_solution.png)

## Измерить беспорядок {#impurtiy}
...
![Вторая группа студентов](../images/posts/trees/data2.png)
...
![Деление по правилу 4 лекций](../images/posts/trees/data2_split4.png)
...
![Решающее дерево для второй группы студентов](../images/posts/trees/tree2.png)

То есть, если студент посетил 4 лекции или меньше, его шансы сдать зачет равны 0%, иначе — 67%.

## Вырастить дерево {#fit}

[Игра "Жизнь" :octicons-link-external-16:](https://ru.wikipedia.org/wiki/%D0%98%D0%B3%D1%80%D0%B0_%C2%AB%D0%96%D0%B8%D0%B7%D0%BD%D1%8C%C2%BB){:target="_blank"} Джона Конвея состоит всего из двух правил. Но эти правила создают устойчивые структуры, бесконечные вихри и плавающие скопления клеток. Сам Конвей не был уверен, существует ли в игре генератор бесконечной жизни, пока его не нашел математик Билл Госпер — спустя несколько месяцев после публикации правил игры. Это пример, когда формулировка алгоритма проще, чем его поведение.
...
![Данные правого листа после деления по правилу 4 лекций](../images/posts/trees/data2_right.png)
...
![Решающее дерево для второй группы студентов, итоговый вариант](../images/posts/trees/tree2_full.png)
...
![Правила решающего дерева для второй группы студентов на плоскости](../images/posts/trees/chart2_solution.png)
...
![Третья группа студентов](../images/posts/trees/data3.png)
...
![Решающее дерево для третьей группы студентов](../images/posts/trees/tree3_overfit.png)
...
![Решающее дерево для третьей группы студентов на плоскости](../images/posts/trees/chart3_solution.png)
...
![Решающее дерево с ограничением по глубине](../images/posts/trees/tree3_max_depth.png)
...
![Решающее дерево с ограничением по количеству студентов на одном листе](../images/posts/trees/tree3_min_samples_leaf.png)
...
![Пример проблематичных данных](../images/posts/trees/chart_xor.png)
...
![Лучшее решение](../images/posts/trees/chart_xor_good_solution.png)
...
![Решение дерева](../images/posts/trees/chart_xor_solution.png)
